...
export interface JobPayloads {
  ...
  /**
   * Брендирование обложки версии по жанру: удаляет оригинальную обложку и
   * ставит нашу (по slug жанра), перекодируя оригинал так, чтобы скачанный
   * файл нёс именно нашу обложку. Ставится при публикации трека из студии —
   * повторяет поведение бота публикации, но с жанром, выбранным в студии.
   */
  "artwork.brand": { versionId: string };
}
